...
function Profile() {
  ...
  return (
    // <div className="mx-4  max-w-sm rounded-lg bg-white text-gray-900 shadow-xl sm:mx-auto sm:max-w-sm md:mx-auto md:max-w-sm lg:mx-auto lg:max-w-sm xl:mx-auto xl:max-w-sm">
  ...
  <div class="flex w-full max-w-md justify-around border-b border-gray-200 dark:border-gray-700">
    {/* <!-- Posts Tab --> */}
    <button
      class="flex flex-col items-center space-y-1 px-4 py-2 text-indigo-600 dark:text-indigo-300 border-b-2 border-indigo-500 focus:outline-none"
    >
      <svg
    ...
    {/* <!-- Saved Tab --> */}
    <button
      class="flex flex-col items-center space-y-1 px-4 py-2 text-gray-700 dark:text-white border-b-2 border-transparent hover:text-indigo-500 dark:hover:text-indigo-300 hover:border-indigo-500 focus:outline-none"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-6 w-6"
