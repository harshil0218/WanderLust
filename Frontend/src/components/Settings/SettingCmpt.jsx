              ...
              {menuOptions.map((option) => (
                <li key={option.id}>
                  <button
                    ...
                    className="w-full text-left p-3 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 border-b-[2px] dark:border-gray-700 border-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-600"
                  >
                    {option.name}
                  </button>
                </li>
          ...
          {activeSection === "account" && (
            <div>
              <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-4">
                <li>
                  <button className="w-full text-left p-3 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 border-b-[2px] dark:border-gray-700 border-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-600">
                    Change Password
                  </button>
                </li>
